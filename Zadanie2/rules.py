...
height_level_lo = fuzz.interp_membership(x_height, height_lo, 21)
height_level_md = fuzz.interp_membership(x_height, height_md, 21)
height_level_hi = fuzz.interp_membership(x_height, height_hi, 21)
temp_level_lo = fuzz.interp_membership(x_temp, temp_lo, 24)
temp_level_md = fuzz.interp_membership(x_temp, temp_md, 24)
temp_level_hi = fuzz.interp_membership(x_temp, temp_hi, 24)
daytime_level_lo = fuzz.interp_membership(x_daytime, daytime_lo, 0.5)
daytime_level_hi = fuzz.interp_membership(x_daytime, daytime_hi, 0.5)
